...
class PartidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partido" do
    assert_difference('Partido.count') do
      post partidos_url, params: { partido: { comentario: @partido.comentario, equipo1: @partido.equipo1, equipo2: @partido.equipo2, fecha: @partido.fecha, resultado: @partido.resultado } }
    end
  ...
  test "should update partido" do
    patch partido_url(@partido), params: { partido: { comentario: @partido.comentario, equipo1: @partido.equipo1, equipo2: @partido.equipo2, fecha: @partido.fecha, resultado: @partido.resultado } }
